        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="more-btn text-center mt-50">
                    <a href="#" class="btn dento-btn booking-btn mr-50">Read More <i
                                class="fa fa-angle-double-right"></i></a>
                    <?php if ($isAdmin) {
                        echo '<a href="editservice.php" class="btn dento-btn booking-btn registr ml-50">New service <i class="fa fa-angle-double-right"></i></a>';
                    } ?>
                </div>
            </div>
        </div>
